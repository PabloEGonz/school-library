...
This project is a database based on the structure needed for a library, and will serve as a tool
to record what books are in the library and who borrows them. This program has the following options:
